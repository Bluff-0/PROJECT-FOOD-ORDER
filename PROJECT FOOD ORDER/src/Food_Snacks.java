...
@WebServlet("/Food_Snacks")
public class Food_Snacks extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.println( 
					...
					"        <a href=\"Food_Snacks\"><button type=\"button\" value=\"Home\" class=\"menub\">Shop</button></a>\r\n" + 
			...
			out.println("<div id=\"full\">\r\n" + 
					...
					"    <center><h1 style=\"color: black; text-shadow: 2px 2px rgba(0,0,0,0.5); font-family: elephant;\"><span style=\"background-color: cornsilk; opacity: 0.9; border-radius: 10%\">&#9679; SNACKS &#9679;</span></h1></center>");
			...
			for(int i=0;i<count;i++)
			{
				if(rs2.next())
				{
					out.println("<div class=\"col-sm-4\">\r\n" + 
							...
							"			<input type=\"hidden\" name=\"foodType\" value=\"Snacks\" class=\"foodType\"/>\r\n" + 
