...
@WebServlet("/Food_Fruits")
public class Food_Fruits extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.println( 
					...
					"        <a href=\"Food_Fruits\"><button type=\"button\" value=\"Home\" class=\"menub\">Shop</button></a>\r\n" + 
			...
			out.println("<div id=\"full\">\r\n" + 
					...
					"    <center><h1 style=\"color: black; text-shadow: 2px 2px rgba(0,0,0,0.5); font-family: elephant;\"><span style=\"background-color: cornsilk; opacity: 0.9; border-radius: 10%\">&#9679; FRUITS AND SALADS &#9679;</span></h1></center>");
