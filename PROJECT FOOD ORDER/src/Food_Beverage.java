...
@WebServlet("/Food_Beverage")
public class Food_Beverage extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public Food_Beverage() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.println("<div id=\"full\">\r\n" + 
					...
					"    <center><h1 style=\"color: black; text-shadow: 2px 2px rgba(0,0,0,0.5); font-family: elephant;\"><span style=\"background-color: cornsilk; opacity: 0.9; border-radius: 10%\">&#9679; BEVERAGES &#9679;</span></h1></center>");
			...
			for(int i=0;i<count;i++)
			{
				if(rs2.next())
				{
					out.println("<div class=\"col-sm-4\">\r\n" + 
							...
							"			<input type=\"hidden\" name=\"foodType\" value=\"Beverage\" class=\"foodType\"/>\r\n" + 
